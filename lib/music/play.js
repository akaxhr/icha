  ...
  "Music",
  {
    inline_keyboard: [
      [
        {
          text: "⏸ Pause",
          callback_data: `music_pause:${chatId}`,
        },
        {
          text: "⏭ Skip",
          callback_data: `music_skip:${chatId}`,
        },
      ],
      [
        {
          text: "🔀 Shuffle",
          callback_data: `music_shuffle:${chatId}`,
        },
        {
          text: "📜 Queue",
          callback_data: `music_queue:${chatId}`,
        },
      ],
      [
        {
          text: "⏹ Stop",
          callback_data: `music_stop:${chatId}`,
        },
      ],
    ],
  }
